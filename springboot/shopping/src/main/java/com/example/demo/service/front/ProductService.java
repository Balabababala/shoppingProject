...
public interface ProductService {
	...
	//邏輯
	//賣家
	void addProduct(SellerProductCreateRequest sellerProductDto,Long userId);						//新增 產品 
	void updateProduct(SellerProductCreateRequest sellerProductDto ,Long productId,Long userId);	//更新 產品
	void deleteProduct(Long productId,Long userId);													//更新 產品 改成刪除狀態 (查資料庫同時 也驗證了身分)
	void unActiveProduct(Long productId,Long userId);												//更新 產品 改成下架狀態 (查資料庫同時 也驗證了身分)
	void activeProduct(Long productId,Long userId);													//更新 產品 改成上架狀態 (查資料庫同時 也驗證了身分)
