...
public class AiReviewService {
    ...
    public List<ReviewResult> reviewAllComments() {
        List<ProductReview> reviews = productReviewRepository.findByApprovedByAiFalse();
        List<ReviewResult> results = new ArrayList<>();

        for (ProductReview review : reviews) {
            if (review.getComment() != null && !review.getComment().isEmpty()) {
                JSONObject result = aiReview(review.getComment());
    ...
    public JSONObject aiReview(String comment) {
